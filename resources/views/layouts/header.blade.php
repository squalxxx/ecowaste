<header class="Header">
    <div class="container">
        <div class="header-top">
            <a class="HeaderNavbar__brand" href="{{ route('index') }}">
                <img
                    alt="Эковейст Групп"
                    class="navbar-brand"
                    src="{{ asset('storage/images/logotype.png') }}"
                >
            </a>
            ...
            <div class="HeaderNavbar__phone">
                ...
                <div class="phone-wrap">
                    <a class="phone" href="tel:79633561039">+7 (963) 356-10-39</a>
                    <a class="mail" href="mailto:help@ecowastegroup.ru">help@ecowastegroup.ru</a>
                </div>
            </div>

            <div class="header-buttons">
                <a class="btn btn-green" href="{{ route('lk.index') }}">Личный кабинет</a>
            </div>
        </div>
        ...
        <nav class="HeaderNavbar">
            ...
            <div class="HeaderMenu HeaderNavbar__nav mx-lg-auto" id="HeaderMenu">
                ...
                <ul class="HeaderMenu__nav nav">
                    <li class="nav-item position-relative">
                        ...
                        >
                            <div class="DropdownMenu__Nav">
                                <a class="DropdownMenu__Item" href="{{ route('services.disposal') }}">
                                    <div class="DropdownItem__head">Утилизация отходов</div>
                                </a>

                                <a class="DropdownMenu__Item" href="{{ route('services.shipping') }}">
                                    <div class="DropdownItem__head">Транспортировка отходов</div>
                                </a>

                                <a class="DropdownMenu__Item" href="{{ route('services.passportisation') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('stocks') }}">Акции</a>
                    </li>
